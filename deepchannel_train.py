...
from keras.layers import Dense, Dropout, Flatten, Reshape, Activation, LSTM, BatchNormalization, TimeDistributed, \
	Conv1D, MaxPooling1D
...
df = pd.read_csv('Random datasets/1 channel/outfinaltest44.csv', header=None)
...
# validation set!!
df_val = pd.read_csv('Random datasets/1 channel/outfinaltest10.csv', header=None)
...
newmodel.save('model/pooling.h5')

make_roc(val_target, predict_val)